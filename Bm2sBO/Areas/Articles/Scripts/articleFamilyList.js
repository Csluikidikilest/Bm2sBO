app.controller('ArticleFamilyList', ['$scope', '$http', '$compile', '$filter', function ($scope, $http, $compile, $filter) {
  ...
  $scope.saveValues = function (line) {
    var url = "/Articles/ArticleFamilies/SetValue";
    var params = {
      articleFamily: line
    };
  ...
  $scope.deleteValue = function (line) {
    var url = "/Articles/ArticleFamilies/DeleteValue";
    var params = {
      articleFamily: line
    };
  ...
  $scope.getValues = function () {
    $scope.Loading = true;
    var url = "/Articles/ArticleFamilies/GetValues";
    var params = {
    };
